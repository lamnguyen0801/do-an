...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="./assets/images/logo-iot.jpg">
    <?php
    if (isset($_GET['quanly'])) {
        switch ($_GET['quanly']) {
            ...
            case 'chitiet':
                ...
                break;
            case 'baiviet':
                echo '<link rel="stylesheet" href="./assets/css/postList.css">';
                break;
            case 'gioithieu':
    ...
    if (isset($_GET['quanly'])) {
        switch ($_GET['quanly']) {
            ...
            case 'chitiet':
                ...
                break;
            case 'baiviet':
                include_once './view/postList.php';
                break;
            case 'login':
                include_once './view/components/login.php';
                break;
            case 'register':
                include_once './view/components/register.php';
                break;
            case 'forgetPassword':
                include_once './view/components/forgetpassword.php';
                break;
            case 'verifyEmail':
                include_once './view/components/verifyEmail.php';
                break;
            case 'changeNewPassWord':
                include_once './view/components/changeNewPassWord.php';
                break;
            case 'admin':
