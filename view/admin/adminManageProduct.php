...
<div class="search-box">
    ...
    <input type="text" name="search" id="search-product" placeholder="Nhập tên hoặc mã sản phẩm"/>
</div>
<table>
    <thead>
        <tr>
    ...
    <tbody id="result">
        ...
        <tr>
            ...
            <td style="width: 10%;">
                <img src="<?php echo $row_sanpham['img_product'] ?>" width="100%" height="120" style="object-fit:contain;">
            </td>
