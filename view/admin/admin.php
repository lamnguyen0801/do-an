...
<div class="container">
    <div class="navigation">
        <ul>
            <li>
                <img src="./assets/images/logo-iot.jpg" alt="logo" class="logo">
            </li>
            <li>
                ...
                if (isset($_GET['action']) && $_GET['action']) {
                    switch ($_GET['action']) {
                        ...
                        case 'manageUser':
                            ...
                            break;
                        case 'manageSlider':
                            include_once('adminManageSlider.php');
                            break;
                        case 'manageProduct':
                            include_once('adminManageProduct.php');
                            break;
                        case 'manageCart':
                            include_once('adminManageCart.php');
                            break;
                        case 'manageCategory':
                            include_once('adminManageCategory.php');
                            break;
                        case 'manageComment':
                            include_once('adminManageComment.php');
                            break;
                        case 'detailCart':
                            include_once('adminDetailCart.php');
                            break;
                        case 'detailProduct':
                            include_once('adminDetailProduct.php');
                            break;
                        case 'changeUser':
                            include_once('adminChangeUser.php');
                            break;
                        case 'changeSlider':
                            include_once('adminChangeSlider.php');
                            break;
                        case 'changeCategory':
                            include_once('adminChangeCategory.php');
                            break;
                        case 'changeProduct':
                            include_once('adminChangeProduct.php');
                            break;
                        case 'changeDetailProduct':
                            include_once('adminChangeDetailProduct.php');
                            break;
                        case 'changeCart':
                            include_once('adminChangeCart.php');
                            break;
                        case 'insertProduct':
                            include_once('adminInsertProduct.php');
                            break;
                        case 'insertDetailProduct':
                            include_once('adminInsertDetailProduct.php');
                            break;
                        case 'insertUser':
                            include_once('adminInsertUser.php');
                            break;
                        case 'insertSlider':
                            include_once('adminInsertSlider.php');
                            break;
                        case 'insertCategory':
                            include_once('adminInsertCategory.php');
                            break;
                    }
                } else {
                    include_once('adminOverview.php');
