...
<div class="search-box">
    ...
    <input type="text" name="search" id="search-category" placeholder="Nhập tên hoặc ID Danh mục"/>
</div>
<table>
    <thead>
        <tr>
    ...
    <tbody id="result">
        ...
        <tr>
            ...
            <td style="width: 10%;">
                <img src="<?php echo  $row_category['img_category'] ?>" width="100%" height="120" style="object-fit:contain;">
            </td>
